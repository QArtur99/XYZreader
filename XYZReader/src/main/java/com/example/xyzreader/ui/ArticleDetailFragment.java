...
//    private DrawInsetsFrameLayout mDrawInsetsFrameLayout;
    ...
    private TextView titleView, bylineView, toolbarTitleView, toolbarBylineView;
    ...
    public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
        ...
        if (percentage > 0.65) {
            toolbarTitleView.setText(titleView.getText());
            toolbarBylineView.setText(bylineView.getText());
            toolbarTitleView.setVisibility(View.VISIBLE);
            toolbarBylineView.setVisibility(View.VISIBLE);
            fab.setVisibility(View.GONE);
        } else {
            fab.setVisibility(View.VISIBLE);
            toolbarTitleView.setVisibility(View.GONE);
            toolbarBylineView.setVisibility(View.GONE);
        }
    }
...
//        mScrollView = (ObservableScrollView) mRootView.findViewById(R.id.nestedScrollView);
